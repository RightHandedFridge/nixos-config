{
  ...
  config = lib.mkIf osConfig.modules.de.kde.enable {
    home.file.".config/kglobalshortcutsrc".text = ''
      ...
      switch-to-activity-8332bde2-9795-4e7c-90f6-b8628c2e85d3=none,none,Switch to activity "Default"
      ...
      activateWhenTypingOnDesktop=,none,
      historyBehaviour=,none,
      position=,none,
      ...
      Kill Window=Alt+Shift+Q,Meta+Ctrl+Esc,Kill Window
      ...
      PoloniumFocusAbove=Alt+I,none,Polonium: Focus Above
      PoloniumFocusBelow=Alt+K,none,Polonium: Focus Below
      PoloniumFocusLeft=Alt+J,none,Polonium: Focus Left
      PoloniumFocusRight=Alt+L,none,Polonium: Focus Right
      ...
      PoloniumSwitchBTree=,none,Polonium: Use Binary Tree Engine
      PoloniumSwitchHalf=,none,Polonium: Use Half Engine
      PoloniumSwitchKwin=,none,Polonium: Use KWin Engine
      PoloniumSwitchMonocle=,none,Polonium: Use Monocle Engine
      PoloniumSwitchThreeColumn=,none,Polonium: Use Three Column Engine
      ...
      Switch to Desktop 5=Alt+5,,Switch to Desktop 5
      ...
      Window Maximize Horizontal=,,Maximise Window Horizontally
      Window Maximize Vertical=,,Maximise Window Vertically
      Window Minimize=Meta+PgDown,Meta+PgDown,Minimise Window
      Window Move=,,Move Window
      Window Move Center=,,Move Window to the Centre
      ...
      Window to Desktop 1=Alt+!,,Window to Desktop 1
      ...
      Window to Desktop 2=Alt+",,Window to Desktop 2
      Window to Desktop 20=,,Window to Desktop 20
      Window to Desktop 3=Alt+£,,Window to Desktop 3
      Window to Desktop 4=Alt+%,,Window to Desktop 4
      Window to Desktop 5=Alt+^,,Window to Desktop 5
      ...
      launch-alacritty=Meta+Return
      launch-krunner=Meta+S
    '';
  };
}
